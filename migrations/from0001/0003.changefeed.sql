...
--
-- PLEASE NOTE:
-- This procedure is inlined into changefeed.sweep_loop; since it was natural
-- to return a table, but insert-exec mechanism has some disadvantages and ended up
-- hiding any errors. We keep this procedure around mainly for unit testing its
-- logic; any change must be kept strictly in sync with changefeed.sweep_loop....
--
